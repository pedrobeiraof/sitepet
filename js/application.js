...
$(document).ready(function () {
    ...
    $('.sections-container').on('click', '.add-section-btn', function(){
        ...
        if ( qtdade < 5 ) {
            ...
            container.find('.sections-list').prepend('<div class="alert alert-warning alert-dismissible">Só é possível adicionar até 5. <button type="button" class="close" data-dismiss="alert" aria-label="fechar"><i class="fa fa-remove"></i></div>')
        }
